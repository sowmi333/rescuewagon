        ...
        <div class="tab-content text-center">
          ...
          <div class="tab-pane active" id="home" role="tabpanel">
            ...
            <div class="container col-12">
              <h5 class="card-title"><span id="name">Dhamu</span></h5>
              <h6 class="card-subtitle mb-2 text-muted">Vehicle ID: <span id="vehicleId">ECHN102</span></h6>
              <br>
              <!-- <ul class="list-group">
...
function calculateAndDisplayRoute(directionsDisplay, directionsService,
  ...
  for (var i = 0; i < markerArray.length; i++) {
   ...
   var end=new google.maps.LatLng(28.536953,77.340875);
...
var destination = new google.maps.LatLng(28.536953,77.340875);
